...
import { Shield, X, Activity, AlertTriangle, GitBranch, Zap, ChevronLeft, ChevronRight } from 'lucide-react';
...
export function CollapsibleContextPanel({ alert, onClose, isCollapsed, onToggle }: CollapsibleContextPanelProps) {
      ...
      {!isCollapsed ? (
        ...
        >
          <div className="flex flex-col items-center">
            <span className="text-lg font-bold" style={{ color: colors.text }}>{confidence}%</span>
            <span className="text-[9px] uppercase" style={{ color: '#52525b' }}>Risk</span>
          </div>
          <motion.button
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
